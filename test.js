...
/***/ function(module, exports, __webpack_require__) {
	...
	var UCInfoDetail = __webpack_require__(221),
		UCSubscribe = __webpack_require__(226),
		UCAttention = __webpack_require__(227),
		UCHouseManage = __webpack_require__(228),
		UCNotes = __webpack_require__(229),
		UCPwdChange = __webpack_require__(231),
		UCMobileChange = __webpack_require__(232),
		UCNickNameChange = __webpack_require__(233),
		UCMobileUnbind = __webpack_require__(234),
		UCOrder = __webpack_require__(235),
		UCFinance = __webpack_require__(236),
		UCMain = __webpack_require__(237);

	var LoginValidator = __webpack_require__(240),
		InfoValidator = __webpack_require__(241);
	...
	var App = React.createClass({displayName: "App",
	    render: function(){
	    	...
	    	if(!this.props.children){
	    		defaultR = (
					React.createElement(UCMain, null)
	    		);
	    	}else{
	    		defaultR = this.props.children;
	    	}
	...
	ReactDOM.render((
		React.createElement(Router, {location: "hash"}, 
			React.createElement(Route, {path: "/", component: App}, 
				React.createElement(Route, {path: "info", component: UCInfoDetail, onEnter: InfoValidator}), 
				React.createElement(Route, {path: "subscribe", component: UCSubscribe, onEnter: LoginValidator}), 
				React.createElement(Route, {path: "attention", component: UCAttention, onEnter: LoginValidator}), 
				React.createElement(Route, {path: "manage", component: UCHouseManage, onEnter: LoginValidator}), 
				React.createElement(Route, {path: "notes", component: UCNotes, onEnter: LoginValidator}), 
				React.createElement(Route, {path: "pwdChange", component: UCPwdChange, onEnter: LoginValidator}), 
				React.createElement(Route, {path: "nickNameChange", component: UCNickNameChange, onEnter: LoginValidator}), 
				React.createElement(Route, {path: "mobileUnbind", component: UCMobileUnbind, onEnter: LoginValidator}), 
				React.createElement(Route, {path: "mobileChange", component: UCMobileChange, onEnter: LoginValidator}), 
				React.createElement(Route, {path: "order", component: UCOrder, onEnter: LoginValidator}), 
				React.createElement(Route, {path: "finance", component: UCFinance, onEnter: LoginValidator}), 
				React.createElement(Route, {path: "*", component: UCMain})
			)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UCHeader = __webpack_require__(222),
		UCFooter = __webpack_require__(224),
		UCBreadCrumb = __webpack_require__(225),
		Tools = __webpack_require__(223);

	var UCInfoDetail  = React.createClass({displayName: "UCInfoDetail",
		hasInitDate: false,
		getInitialState: function(){
			return {
				res: {
					data: {
						...
						userName: '',
						nickName: '',
						avatar: 'http://a1.itc.cn/sceapp/focus_static/passport/images/default_avatar.jpg',
						gender: 0,
						birthDay: '',
						mobile: '',
						changeStatus: 0,
		...
		componentDidMount: function(){
			...
			$('#avatarUploader').on('click', function(e){
				console.log(e);
				e.stopPropagation();
			});
			$('#avatarUploader').on('change', function(e){
				var data = new FormData();

				var file = e.target.files[0];
				if(!file || !/image\/.*/i.test(file.type)) {
						That.handleShowUpload();
						return;
				}
				...
				xhr.open('post', '/wap/user/updateavatar');
				xhr.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
				// xhr.upload.addEventListener('progress', this._handleUploadImgProgress.bind(this));
				// xhr.upload.addEventListener('load', this._handleUploadImgFinished.bind(this));
				xhr.addEventListener('readystatechange', (function(e) {
					if(xhr.readyState === 4 && xhr.status === 200) {
						That._handleUploadImgSuccess(xhr.response);
					}else if(xhr.status === 413){
						That._handleUploadImgFailure(xhr.response, 'large');
					}
				}));
				xhr.send(data);
			});
		},
		_handleUploadImgSuccess: function(e){
			var res = $.parseJSON(e);
			console.log(res);
			if(res.errorCode == 0){
				var newState = Tools.clone(this.state);
				newState.res.data.avatar = res.data.avatar;
		...
		handleShowConfirm: function(){
			var newState = Tools.clone(this.state);
				if(newState.res.data.changeStatus == 1) {
					newState.showChanged = true;
				}else
					newState.showConfirm = true;
				this.setState(newState);
		},
		handleHideUpload: function(){
			var newState = Tools.clone(this.state);
				newState.showUpload = false;
				this.setState(newState);
		},
		handleHideConfirm: function(){
			var newState = Tools.clone(this.state);
				newState.showConfirm = false;
				this.setState(newState);
		},
		handleHideChanged: function(){
			var newState = Tools.clone(this.state);
				newState.showChanged = false;
				this.setState(newState);
		},
		handleShowGender: function(){
			var newState = Tools.clone(this.state);
				newState.showGender = true;
				this.setState(newState);
		},
		handleHideGender: function(){
			var newState = Tools.clone(this.state);
				newState.showGender = false;
				this.setState(newState);
		},
		handleShowBirth: function(){
			var newState = Tools.clone(this.state);
				newState.showBirth = true;
				this.setState(newState);
			if(this.hasInitDate=== false){
				$('#beginTime').date({
					dateDay: this.state.res.data.birthDay
				});
		...
		handleHideBirth: function(){
			var newState = Tools.clone(this.state);
				newState.showBirth = false;
				this.setState(newState);
		},
		handleConfirmDate: function(){
			var y = $("#yearwrapper ul").find('li').eq((-yearScroll.y/30) + 2).attr('data-y'),
				m = $("#monthwrapper ul").find('li').eq((-monthScroll.y/30) + 2).attr('data-m'),
				d = $("#daywrapper ul").find('li').eq((-dayScroll.y/30) + 2).attr('data-d');

			var showStr = y + '-' + m + '-' + d,
				dateStr = y + (m.length == 1 ? ('0' + m) : m ) + (d.length == 1 ? ('0' + d) : d);

			this.updateUserBirth(dateStr, showStr);
		...
		handleUploadAvatar: function(){
			$('#avatarUploader').trigger('click');
		},
		handleMobileChange: function(e){
			var That = this;
			var checkReg = /^1[3|4|5|7|8]\d{9}\@(focus\.)?sohu\.com/;
			var checkRegOld = /^ppag[0-9a-f]{12}\@sohu\.com/;
			if(this.state.res.data.userName.match(checkReg) != null ||
				...
				e.preventDefault();
			}else if(this.state.res.data.mobile == ''){
				var newState = Tools.clone(That.state);
					newState.mobilePath = '/mobileChange';
					That.setState(newState);
			}
		...
		render: function(){
			...
			React.createElement("div", null, 
					...
					React.createElement("div", {className: "my-info-form"}, 
						React.createElement("div", {className: "info-item clearfix", onClick: this.handleUploadAvatar}, 
							...
							React.createElement("span", {className: "avatar-item item-right"}, 
								...
								React.createElement("input", {type: "file", id: "avatarUploader", style: {display: 'none'}})
							)
						), 
				...
				React.createElement("div", {className: this.state.showSuc == false ? "suc-box hidden-box" : "suc-box"}, 
					React.createElement("div", {className: "suc-wrapper"}, 
						React.createElement("p", null, this.state.sucText)
					)
				)
				), 
				React.createElement(UCBreadCrumb, {data: brData}), 
	        	React.createElement(UCFooter, null)
	    	)
			);
		}
	});

	module.exports = UCInfoDetail;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Tools = __webpack_require__(223);
	var UCHeader = React.createClass({displayName: "UCHeader",
		render: function(){
			var url  = "http://m."+Tools.getHostName()+".cn/";
			return (
				React.createElement("header", {className: "public-header"}, 
		            React.createElement("a", {href: url, className: "public-header-logo"}), 
		            React.createElement("h1", {className: "public-header-title"}, this.props.data.title)
		        )
			);
		}
	});

	module.exports = UCHeader;
...
/***/ function(module, exports) {
	...
	var Tools = {
		...
		getMinHeight: function(extra){
			var dH = $(document).height(),
				headerH = $('header').height() == null ? 0 : $('header').height(),
				footerH = $('footer').height() == null ? 0 : $('footer').height(),
				breadH = $('.public-breadcrumb-bottom').height() == null ? 0 : $('.public-breadcrumb-bottom').height(),
				extraH = extra.height();
		...
		queryByNameFn: function(name, url){
		    /* jshint ignore:start */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UCFooter = React.createClass({displayName: "UCFooter",
		mockLink: function(){
			window.location.href="http://house.focus.cn?cfrom=mobile";
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UCBreadCrumb = React.createClass({displayName: "UCBreadCrumb",
		render: function(){
			var items = [],
			...
			for(var i = 0; i < data.length; i++){
				if(i == 0){
					items.push(React.createElement("a", {href: data[i].link, key: data[i].key}, data[i].text));
					items.push(React.createElement("span", {className: "h_space1", key: data[i].key + 'h'}));
				}else if(i == data.length - 1){
					items.push(React.createElement(Link, {to: data[i].link, key: data[i].key, className: "cur-link"}, data[i].text));
				}else{
					items.push(React.createElement(Link, {to: data[i].link, key: data[i].key}, data[i].text));
					items.push(React.createElement("span", {className: "h_space1", key: data[i].key + 'h'}));
				}
			}
			return (
				React.createElement("div", {className: "public-breadcrumb-bottom"}, 
					items
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SubscribeBar = React.createClass({displayName: "SubscribeBar",

		handleChangeTab: function(e){
			var index = $(e.target).index();

			this.props.triggerChangeTab(index);
		},
	...
	var SubscribeTool = React.createClass({displayName: "SubscribeTool",
		getInitialState: function(){
			return {
				show: 0,
				selectAll: false,
		...
		showCancelBar: function(){
			var newState = Tools.clone(this.state);
				newState.show = 1;
				this.setState(newState);

			this.props.triggerListType(1);
		},
		hideCancelBar: function(){
			var newState = Tools.clone(this.state);
				newState.show = 0;
				this.setState(newState);

			this.props.triggerListType(0);
		},
		...
		cancelSubscribe: function(){
			var selectedIcons = $('.subscribe-list').find('.selected'),
				removedItems = [],
				removedIds = [];

			for(var i = 0; i < selectedIcons.length; i++){
				removedItems.push(selectedIcons.eq(i).parents('.item-box'));
			}

			for(var i = 0; i < removedItems.length; i++){
				this.cancelAjax(removedItems[i], removedItems[i].attr('data-groupid'), removedItems[i].attr('data-mobile'));
			}
		},

		cancelAjax: function(That, gid, mobile){
			$.ajax({
				url: '/dingyue/loupan/update',
				type: 'post',
				dataType: 'json',
				data: 'groupId='+ gid +'&dingyueMobile='+ mobile +'&change_price=0&open=0&news=0&kanfangtuan=0&discount=0',
				success: function(e){
					if(e.errorCode === 0){
						if($(That).parents('.dingyue-item').find('.item-box').length == 1){
							$(That).parents('.dingyue-item').remove();
							if($('.dingyue-item').length == 0){
								manageBtn.hide();
							}
						}else{
							$(That).remove();
	...
	var SubscribeItems = React.createClass({displayName: "SubscribeItems",
		...
		render: function(){
			var items = this.props.data.map(function(item){
				return (
					React.createElement("div", {className: "item-box", "data-groupid": item.groupId, "data-mobile": item.mobile}, 
						React.createElement("a", {href: item.link, className: "item-container"}, 
							React.createElement("img", {src: item.groupImg, className: "item-img"}), 
							React.createElement("div", {className: "item-info"}, 
								React.createElement("p", {className: "item-title"}, item.groupName), 
								React.createElement("p", {className: "item-location"}, 
						...
						React.createElement("div", {className: "item-select"}, 
							...
							React.createElement("div", {className: "copy-body"}, 
								React.createElement("span", {className: "select-icon"}, 
									React.createElement("span", {className: "inner-icon"})
								)
							), 
							React.createElement("div", {className: "copy-footer"})
						)
					)
				);
			});
	...
	var HouseList = React.createClass({displayName: "HouseList",
		getInitialState: function(){
			return {
				res: {
					data: {
		...
		componentDidMount: function(){
			var That = this;
			$('.none-kft').css('min-height', $(window).height() - $('header').height() - $('.attention-bar').height() + 'px');
			$.ajax({
				url: '/dingyue/loupan/listajax',
				type: 'get',
				dataType: 'json',
				data: 'pageNo=1',
				success: function(res){
		...
		render: function(){
			...
			return (
				React.createElement("div", {className: "dingyue-items"}, 
					items
				)
			);
		}
	...
	var EsfList = React.createClass({displayName: "EsfList",
		componentDidMount: function(){
			$('.none-kft').css('min-height', $(window).height() - $('header').height() - $('.attention-bar').height() + 'px');
		},
		render: function(){
			...
			return (
				React.createElement("div", {className: "kft-list"}, 
					items
				)
			);
		}
	...
	var SubscribeList = React.createClass({displayName: "SubscribeList",
		render: function(){
			var showClass = 'subscribe-list';
			if(this.props.showCancel == 0){
				showClass = "subscribe-list cancel-back";
			}else if(this.props.showCancel == 1){
				showClass = "subscribe-list cancel-actived";
			}
			var data = [];
			if(this.props.refs == 0){
				data =	React.createElement(HouseList, null)
			}else if(this.props.refs == 1){
				data = React.createElement(EsfList, null)
			}
			return (
				React.createElement("div", {className: showClass}, 
					data
				)
			);
		}
	...
	var UCSubscribe = React.createClass({displayName: "UCSubscribe",
		mixins: [History],
		getInitialState: function(){
			return {
				showTab: 0,
		...
		componentWillMount: function(){
			...
			$.ajax({
				...
				success: function(res){
					if(res.errorCode === 0){
						if(res.data.user.mobile == undefined || res.data.user.mobile == ''){
							That.history.replaceState(null, '/');
							document.location.href = 'http://login.'+hostName+'.cn/mobile/bind?ru='+ encodeURIComponent('http://' + document.location.host + '/myfocus#subscribe');
						}else{
							var newState = Tools.clone(That.state);
							newState.show = true;
							That.setState(newState);
						...
						That.history.replaceState(null, '/');
						document.location.href = 'http://login.'+hostName+'.cn/login?ru='+ encodeURIComponent('http://' + document.location.host + '/myfocus#subscribe');
					}
				}
			});
		},
		...
		render: function(){
			return (
				React.createElement("div", {className: "my-subscribe", style: {'display': this.state.show == true ? 'block' : 'none'}}, 
					React.createElement(SubscribeBar, {refs: this.state.showTab, triggerChangeTab: this.handleChangeTab}), 
					React.createElement(SubscribeTool, {refs: this.state.showTab}), 
					React.createElement(SubscribeList, {refs: this.state.showTab, showCancel: this.state.showCancel})
				)
			);
		}
	});

	module.exports = UCSubscribe;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoupanItems = React.createClass({displayName: "LoupanItems",
		render: function(){
			...
			if(tmpData.discount != ''){
				youhui = React.createElement("p", {className: "group-youhui"}, tmpData.discount);
			}else{
				youhui = '';
			}
			link = 'http://m.focus.cn/' + tmpData.cityPrefix + '/loupan/' + tmpData.groupId;

			return (
				React.createElement("div", {className: "items", key: tmpData.groupId}, 
					React.createElement("a", {className: "item-detail", href: link}, 
						React.createElement("img", {src: tmpData.logoUrl, className: "item-img"}), 
						React.createElement("div", {className: "item-info"}, 
							React.createElement("p", {className: "group-name"}, tmpData.groupName), 
							React.createElement("p", {className: "group-location"}, tmpData.districtName, tmpData.address), 
							React.createElement("p", {className: "group-price"}, React.createElement("span", null, tmpData.showPrice)), 
							youhui
						)
					)
				)
	...
	var LoupanList = React.createClass({displayName: "LoupanList",
		pageNo: 0,
		getInitialState: function(){
			return {
				res: {
		...
		handleBindLoupanScroll: function(){
			$(window).on('scroll', this.handleScrollLoupanEvent);
		},
		handleUnbindLoupanScroll: function(){
			$(window).off('scroll', this.handleScrollLoupanEvent);
		},
		handleScrollLoupanEvent: function(){
			if(this.props.triggerGetTab() != 0){
				this.handleUnbindLoupanScroll();	
				return;
			}
		...
		handleAjaxUpdate: function(){
			...
			$.ajax({
				url: '/wap/concern/house',
				type: 'post',
				dataType: 'json',
				data: 'pageNo='+ this.pageNo +'&pageSize=5',
				success: function(res){
					if(That.isMounted()){
						var newState = Tools.clone(That.state);

						var newData = newState.res.data.data.concat(res.data.data);
						newState.loading = true;
						newState.res.data.data = newData;
						That.setState(newState);
					}
					if(res.data.hasNext){
						That.handleBindLoupanScroll();
					}
				}
			});
		},
		render: function(){
			...
			var concernedData = this.state.res.data.data,
					tmpTime = '';

			if(this.state.loading === false){
				
				var h = $(window).height() - $('header').height() - $('.attention-bar').height() + 'px';

				lists = (
					React.createElement("div", {className: "loading-box", style: {'width': '100%', 'height': h}}, 
				...
				if(concernedData[0] == undefined){
					...
					for(var i = 0; i < concernedData.length; i++){
						if(tmpTime == concernedData[i].concernedTime){
							lists.push(React.createElement(LoupanItems, {data: concernedData[i], key: concernedData[i].groupId}));
						}else{
							var nDate = new Date(),
								concernedDate = new Date(concernedData[i].concernedTime);
							...
							lists.push(React.createElement(LoupanItems, {data: concernedData[i], key: concernedData[i].groupId}));
							tmpTime = concernedData[i].concernedTime;
						}
					}
				}
			}
			...
			return (
				React.createElement("div", {className: "loupan-list"}, 
					lists
				)
			);
		}
	...
	var KftList = React.createClass({displayName: "KftList",
		pageNo: 0,
		getInitialState: function(){
			return {
				res: {
		...
		handleBindScroll: function(){
			$(window).on('scroll', this.handleScrollEvent);
		},
		handleUnbindScroll: function(){
			$(window).off('scroll', this.handleScrollEvent);
		},
		handleScrollEvent: function(){
			if(this.props.triggerGetTab() != 2){
				this.handleUnbindScroll();	
				return;
			}
			if($(window).scrollTop() + $(window).height() >= $(document).height()){
				this.handleAjaxUpdate();
		...
		render: function(){
			var items;
			var tmpData = this.state.res.data.data,
				lists = [];
					...
					for(var i = 0; i < tmpData.length;i++){
						...
						lists.push(
							React.createElement("a", {className: "item-kft", href: link, key: tmpData[i].lineId}, 
								React.createElement("img", {src: tmpData[i].picUrl, className: "item-img"}), 
								React.createElement("div", {className: "item-info"}, 
	...
	var HxList = React.createClass({displayName: "HxList",
		pageNo: 0,
		getInitialState: function(){
			return {
				res: {
		...
		render: function(){
			...
			if(this.state.loading === false){
				...
				if(tmpData.length == 0){
					...
					for(var i = 0; i < tmpData.length; i++){
						var link = 'http://m.focus.cn/' + tmpData[i].cityPrefix + '/loupan/' + tmpData[i].groupId + '/huxing/' + tmpData[i].layoutId,
							tel = 'tel:' + tmpData[i].phone400;

						list.push(
							React.createElement("div", {className: "item-hx", key: tmpData[i].layoutId}, 
								React.createElement("a", {className: "item-tel", href: tel}), 
								React.createElement("a", {className: "item-link-box", href: link}, 
									React.createElement("img", {src: tmpData[i].picUrl, className: "item-img"}), 
									React.createElement("div", {className: "item-info"}, 
										React.createElement("p", {className: "group-name"}, 
											React.createElement("span", {className: "layout-type"}, tmpData[i].layoutType), 
			...
			return (
				React.createElement("div", {className: "hx-list"}, 
					list
				)
			);
		}
	...
	var EsfList = React.createClass({displayName: "EsfList",
		componentDidMount: function(){
			$('.none-kft').css('height', $(window).height() - $('header').height() - $('footer').height() - $('.public-breadcrumb-bottom').height() -$('.attention-bar').height() + 'px');
		},
		render: function(){
			var list = [];
			...
			return (
				React.createElement("div", {className: "esf-list"}, 
					list
				)
			);
		}
	...
	var AttentionList = React.createClass({displayName: "AttentionList",
		getInitialState: function(){
			return {
				showTab: this.props.refs
			}
		},
		getTabIndex: function(){
			return this.props.triggerGetTab();
		},
		render: function(){
			var data = [];
			if(this.props.refs == 0){
				data =	React.createElement(LoupanList, {triggerGetTab: this.getTabIndex})
			}else if(this.props.refs == 1){
				data = React.createElement(HxList, {triggerGetTab: this.getTabIndex})
			}else if(this.props.refs == 2){
				data =	React.createElement(KftList, {triggerGetTab: this.getTabIndex})
			}else if(this.props.refs == 3){
				data = React.createElement(EsfList, {triggerGetTab: this.getTabIndex})
			}
			return (
				React.createElement("div", {className: "attention-list"}, 
					data
				)
			);
		}
	...
	var AttentionBar = React.createClass({displayName: "AttentionBar",
		handleChangeTab: function(e){
			var index = $(e.target).index();
	...
	var UCAttention = React.createClass({displayName: "UCAttention",
		getInitialState: function(){
	        return {
	            showTab: 0
	        };
	    ...
	    getTabIndex: function(){
	    	return this.state.showTab;
	    },
	    componentDidMount: function(){
	    	$(window).scrollTop(0);
			$('.my-attention').css('min-height', $(window).height() - $('header').height() - $('.attention-bar').height() + 'px');
		},
		render: function(){
			var brData = [
				{
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UCHouseManage = React.createClass({displayName: "UCHouseManage",
		mixins: [History],
		getInitialState: function(){
			return {
				show: false
			...
			$.ajax({
				...
				success: function(res){
					if(res.errorCode === 0){
						if(res.data.user.mobile == undefined || res.data.user.mobile == ''){
							That.history.replaceState(null, '/');
							document.location.href = 'http://login.'+hostName+'.cn/mobile/bind?ru='+ encodeURIComponent('http://' + document.location.host + '/myfocus#manage');
						}else{
							var newState = Tools.clone(That.state);
							newState.show = true;
							That.setState(newState);
						...
						That.history.replaceState(null, '/');
						document.location.href = 'http://login.'+hostName+'.cn/login?ru='+ encodeURIComponent('http://' + document.location.host + '/myfocus#manage');
					}
				}
			});
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UCHeader = __webpack_require__(222),
		UCFooter = __webpack_require__(224),
		UCBreadCrumb = __webpack_require__(225),
		LoadingBox = __webpack_require__(230),
		Tools = __webpack_require__(223),
		History = __webpack_require__(159).History;

	var hostName = Tools.getHostName();
	var NotesBar = React.createClass({displayName: "NotesBar",
		handleChangeTab: function(e){
			var index = $(e.target).index();
			this.props.triggerChangeTab(index);
		},
	...
	var HouseKftList = React.createClass({displayName: "HouseKftList",
		pageNo: 0,
		ajaxUrl: '/wap/housevisit/mykft',
		sendType: 0,
		getInitialState: function(){
			return {
				res: {
		...
		componentDidUpdate: function(){
			if($('.kft-item-enable').length > 0){
				$('.list-label').eq(0).removeClass('hidden-label');
			}
			if($('.personal-item-enable').length > 0){
				$('.list-label').eq(1).removeClass('hidden-label');
			}
			if($('.kft-item-disable').length > 0){
				$('.list-label').eq(2).removeClass('hidden-label');
			}
			if($('.personal-item-disable').length > 0){
				$('.list-label').eq(3).removeClass('hidden-label');
			}
		},
		handleBindScroll: function(isExpired){
			$(window).on('scroll', this.handleScrollEvent);
		},
		handleUnbindScroll: function(){
			$(window).off('scroll', this.handleScrollEvent);
		...
		handleAjaxUpdate: function(){
			...
			if(this.sendType == 1 || this.sendType == 3){
				this.ajaxUrl = '/wap/housevisit/mybooking';
			}else{
				this.ajaxUrl = '/wap/housevisit/mykft';
			}
			$.ajax({
				url: this.ajaxUrl,
				type: 'post',
				...
				success: function(res){
					if(That.isMounted()){
						...
						//state concat
						if(res.data.total == 0){
							newState.isNoneData = newState.isNoneData + 1;
						}
						for(var j = 0; j < res.data.data.length; j++){
							res.data.data[j].sendType = That.sendType;
						}
						newState.loaded = true;
						var newArr = newState.res.data.data.concat(res.data.data);
		...
		render: function(){
			...
			if(this.state.loaded == false){
				...
				lists = React.createElement(LoadingBox, null);
				...
				if(tmpData.length > 0){
					for(var i = 0; i < tmpData.length; i++){
						...
						if(tmpData[i].sendType == 0 || tmpData[i].sendType == 2){

							var overIcon = '',
								guideMobile = '',
								goufangLink = 'javascript:;',
								dianpingLink = 'javascript:;',
								timerShow = '';
							...
							if(tmpData[i].guideMobile != ''){
								...
								guideMobile = React.createElement("a", {href: telShow, className: "item-tel"});
							}
							if(tmpData[i].isRealJoin){
								goufangLink = 'http://m.'+ hostName +'.cn/pft/intention/page?mobile='+ tmpData[i].guideMobile +'&cityId=' + tmpData[i].cityId + '&cityName='+ tmpData[i].cityPrefix +'&lineId='+ tmpData[i].lineId +'&realName=' + tmpData[i].applyName;
								dianpingLink = 'http://m.'+ hostName +'.cn/pft/comment/page?mobile='+ tmpData[i].guideMobile +'&cityId='+ tmpData[i].cityId +'&cityName='+ tmpData[i].cityPrefix +'&lineId='+ tmpData[i].lineId +'&realName=' + tmpData[i].applyName;
							}

							if(tmpData[i].sendDate){
								timerShow = tmpData[i].sendDate.substr(0, 4) + '-' +tmpData[i].sendDate.substr(4, 2) + '-' +tmpData[i].sendDate.substr(6);
							}

							if(tmpData[i].sendType == 0){
								lists.push(
									React.createElement("div", {className: "kft-item kft-item-enable", key: i}, 
										React.createElement("div", {className: "item-name"}, 
											React.createElement("p", {className: "item-title"}, overIcon, tmpData[i].title), 
											React.createElement("p", {className: "item-desc"}, tmpData[i].subTitle)
										), 
								...
								lists3.push(
									React.createElement("div", {className: "kft-item kft-item-disable", key: i}, 
										React.createElement("div", {className: "item-name"}, 
											React.createElement("p", {className: "item-title"}, overIcon, tmpData[i].title), 
											React.createElement("p", {className: "item-desc"}, tmpData[i].subTitle)
										), 
							...
							if(tmpData[i].discount != ''){
								discountShow = React.createElement("p", {className: "item-youhui"}, tmpData[i].discount);
							}
							if(tmpData[i].realtorMobile != ''){
								var telShow = "tel:" + tmpData[i].realtorMobile;
								phoneShow = React.createElement("a", {href: telShow, className: "guwen-phone"});
							}

							link = 'http://m.'+ hostName +'.cn/' + tmpData[i].cityPrefix + '/loupan/' + tmpData[i].groupId + '/';

							if(tmpData[i].sendType == 1){
								lists2.push(
									React.createElement("div", {className: "personal-item personal-item-enable", key: i}, 
										React.createElement("div", {className: tmpData[i].sendType == 3 ? "show-cover": "hide-cover"}, 
										...
										React.createElement("div", {className: "item-info"}, 
											...
											React.createElement("div", {className: "item-text"}, 
												React.createElement("p", {className: "item-title"}, tmpData[i].groupName), 
										...
										React.createElement("div", {className: "item-guwen"}, 
											...
											React.createElement("div", {className: "guwen-item"}, 
												...
												React.createElement("p", {className: "guwen-tel"}, tmpData[i].realtorMobile), 
												phoneShow
											)
										)
									)
								...
								lists4.push(
									React.createElement("div", {className: "personal-item personal-item-disable", key: i}, 
										React.createElement("div", {className: tmpData[i].sendType == 3 ? "show-cover": "hide-cover"}, 
											React.createElement("div", {className: "over-icon"})
										), 
										React.createElement("div", {className: "time-bar"}, 
					...
					if(this.state.isNoneData == 4){
						var h = $(window).height() - $('header').height() - $('.notes-bar').height() - $('.public-breadcrumb-bottom').height() + 'px';
						...
						$('.list-label').addClass('hidden-label');
					}else{
						lists = React.createElement(LoadingBox, null);
					}
				}
			...
			var h = $(window).height() - $('header').height() - $('.notes-bar').height() - $('footer').height() - $('.public-breadcrumb-bottom').height() + 'px';
	...
	var NotesList = React.createClass({displayName: "NotesList",
		render: function(){
			...
			var data = [];
			if(this.props.refs == 0){
				data = React.createElement(HouseKftList, null);
			}else if(this.props.refs == 1){
				data = React.createElement(DiaryList, null);
			}
			return (
				React.createElement("div", {className: "kft-list"}, 
					data
	...
	var DiaryList = React.createClass({displayName: "DiaryList",
		pageNo: 0,
		getInitialState: function(){
			return {
				res: {
			...
			$.ajax({
				...
				success: function(res){
					if(That.isMounted()){
						...
						var newArr = newState.res.data.data.concat(res.data.data);
						newState.res.data.total = res.data.total;
						newState.res.data.data = newArr;
						newState.loaded = true;
						That.setState(newState);
						//åˆ¤æ–­æ˜¯å¦æœ‰ä¸‹ä¸€é¡µ
		...
		render: function(){
			...
			if(window.navigator.userAgent.toLowerCase().indexOf('android') === -1){
				...
				downLoadLink = 'http://xinfang.cdn.sohusce.com/apk/FocusApartment.apk#weixin.qq.com';
			}
			var noneTips = (
			...
			var items = [],
				diaryData = this.state.res.data.data;
			...
			if(this.state.loaded === false){
				items = React.createElement(LoadingBox, null);
			}else{
				if(diaryData.length != 0){
					for(var i = 0; i < diaryData.length; i++){
						...
						if(diaryData[i].imgUrl != ''){
							...
							img = React.createElement("img", {className: "diary-imgs", src: "http://s.m.focus.cn/usercenter/images/none_img.jpg"})
						}
			...
			return (
				React.createElement("div", {className: "diary-list", style: {'minHeight': ($(window).height() - $('header').height() - $('.notes-bar').height() - $('footer').height()) + 'px'}}, 
				items
				)
			);
		}
	...
	var UCNotes = React.createClass({displayName: "UCNotes",
		mixins: [History],
		getInitialState: function(){
			return {
				showTab: 0,
			...
			$.ajax({
				...
				success: function(res){
					if(res.errorCode === 0){
						if(res.data.user.mobile == undefined || res.data.user.mobile == ''){
							That.history.replaceState(null, '/');
							document.location.href = 'http://login.'+hostName+'.cn/mobile/bind?ru='+ encodeURIComponent('http://' + document.location.host + '/myfocus#notes');
						}else{
							var newState = Tools.clone(That.state);
							newState.show = true;
							That.setState(newState);
						...
						That.history.replaceState(null, '/');
						document.location.href = 'http://login.'+hostName+'.cn/login?ru='+ encodeURIComponent('http://' + document.location.host + '/myfocus#notes');
					}
				}
			});
		},
		componentDidMount: function(){
			...
			$(document).on('click', '.sign-info', function () {
	            ...
	            overlay.show();
	            overlayCon.show().find('.other-purpose-text-tip').html(userName + '  ' + userPhone);
	        });

	        overlayCancel.on('click', function () {
	            overlay.hide();
	            overlayCon.hide().find('.other-purpose-text-tip').html('');
	        });

	        overlayConfirm.on('click', function () {
	            overlayCancel.click();
	        });
		},
		render: function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoadingBox = React.createClass({displayName: "LoadingBox",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UCPwdChange = React.createClass({displayName: "UCPwdChange",
		componentDidMount: function(){
			$(window).scrollTop(0);
		},
		render: function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hostName = Tools.getHostName();
	var UCMobileChange = React.createClass({displayName: "UCMobileChange",
		getInitialState: function(){
			return {
				mobile: '',
				code: '',
				sendFlag: true,
				img: '',
				imgcode: 'http://login.'+hostName+'.cn/imgcode/getCaptcha?type=0'
			}
		},
		componentDidMount: function(){
			$(window).scrollTop(0)
			$('.mobile-change-box').css('min-height', $(window).height() - $('header').height() - $('footer').height() - $('.public-breadcrumb-bottom').height() + 'px');
		},
		handleMobileChange: function(e){
			var newState = Tools.clone(this.state);
				newState.mobile = e.target.value;
			this.setState(newState);
		},
		...
		handleImgChange: function(e){
			var newState = Tools.clone(this.state);
				newState.img = e.target.value;
				this.setState(newState);
		},
		changeImg: function(){
			var newState = Tools.clone(this.state);
				newState.imgcode = 'http://login.'+hostName+'.cn/imgcode/getCaptcha?type=0&t=' + new Date().getTime();
				this.setState(newState);
		},
		handleGetCode: function(e){
			var That = this;
			var checkReg = /^1[3|4|5|7|8]\d{9}$/;

			if(this.checkMobile() && this.checkImg()){
				if(this.state.sendFlag){
					var newState = Tools.clone(That.state);
						newState.sendFlag = false;
						That.setState(newState);
					$.getJSON('http://login.'+hostName+'.cn/imgcode/verifycaptcha?input=' + That.state.img + '&callback=?', function(res){
						if(res.errorCode === 0){
							$.ajax({
						        url: 'http://login.'+hostName+'.cn/captcha/secure/getMobileCaptcha',
						        type: 'get',
						        data: 'mobile=' + That.state.mobile + '&imgcode='+ That.state.img +'&type=3&callback=?',
						        dataType:'script',
						        processData:false,
		...
		checkMobile: function(){
			...
			if(checkReg.test(this.state.mobile)){
				return true;
			}else{
				$('input:focus').blur();
				setTimeout(function(){
		...
		handleBindMobile: function(){
			var That = this;
			if(this.checkMobile() && this.checkImg() && this.checkCode()){
				$.ajax({
			        url: 'http://login.'+hostName+'.cn/mobile/bindMobile',
			        type: 'get',
			        data: 'mobile=' + this.state.mobile + '&imgcode='+ this.state.img +'&captcha='+ this.state.code +'&callback=?',
			        dataType:'script',
			        processData:false,
			        jsonpCallback : 'getCodeCallBack',
			        async:false,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UCNickNameChange = React.createClass({displayName: "UCNickNameChange",
		getInitialState: function(){
			return {
				nickName: ''
			}
		...
		componentDidMount: function(){
			$(window).scrollTop(0)
			$('.nickname-change-box').css('min-height', $(window).height() - $('header').height() - $('footer').height() - $('.public-breadcrumb-bottom').height() + 'px');
		},
		...
		nameLenCheck: function(str) {
	          ...
	          for (var i = 0; i <= ta.length - 1; i++) {
	            str_l++;
	            if (Number(ta[i].charCodeAt()) > 255 || Number(ta[i].charCodeAt()) == 32 || Number(ta[i].charCodeAt()) == 13 || Number(ta[i].charCodeAt()) == 10) {
	              str_l++;
	            }
	          }
	          if (str_l >= 4 && str_l <= 20) {
		...
		handleSaveNick: function(){
			if(this.state.nickName != ''){
				//var reg = /^[a-z_0-9A-Z]{4,20}$|^[\u4e00-\u9fa5]{2,10}$/;
			
				if(this.nameLenCheck(this.state.nickName)){
					$.ajax({
						url: '/wap/user/updatenick',
						type: 'post',
						data: 'nickName=' + this.state.nickName,
						dataType: 'json',
						success: function(res){
							if(res.errorCode == 0){
								var ru = Tools.queryByNameFn('ru', document.location.href);

								if(ru != ''){
									document.location.href = ru;
								}else{
									document.location.href = '/myfocus#/info';
								}
							}else{
								alert(res.errorMessage);
							}
	...
	module.exports = UCNickNameChange;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hostName = Tools.getHostName();
	var UCMobileUnbind = React.createClass({displayName: "UCMobileUnbind",
		getInitialState: function(){
			return {
				mobile: '',
				code: '',
			...
			if(!window.uinfo){
				$.ajax({
					...
					success: function(res){
						if(That.isMounted()){
							var newState = Tools.clone(That.state);
							newState.mobile = res.data.mobile;
							if(newState.mobile != ''){
								newState.showMobile = newState.mobile.substr(0, 3) + '****' + newState.mobile.substr(7);
							}
							That.setState(newState);
						}
					}
				...
				var newState = Tools.clone(That.state);
					newState.mobile = window.uinfo.mobile;
					if(newState.mobile != ''){
						newState.showMobile = newState.mobile.substr(0, 3) + '****' + newState.mobile.substr(7);
					}
					That.setState(newState);
				...
				$.getJSON('http://login.'+hostName+'.cn/imgcode/verifycaptcha?input=' + That.state.img + '&callback=?', function(res){
					if(res.errorCode === 0){
						$.ajax({
					        url: 'http://login.'+hostName+'.cn/captcha/secure/getMobileCaptcha',
					        type: 'get',
					        data: 'mobile=' + That.state.mobile + '&imgcode='+ That.state.img +'&type=4&callback=?',
					        dataType:'script',
					        processData:false,
					        jsonpCallback : 'getCodeCallBack',
					        async:false,
		...
		handleUnbindMobile: function(){
			var That = this;
			if(this.state.code != ''){
				$.ajax({
			        url: 'http://login.'+hostName+'.cn/passport/unbindMobile',
			        type: 'get',
			        data: 'mobile=' + this.state.mobile + '&imgcode='+ this.state.img +'&captcha='+ this.state.code +'&callback=?',
			        dataType:'script',
			        processData:false,
			        ...
			        success: function(res){
			            if(res.errorCode === 0){
			            	alert(res.errorMessage);
			            	document.location.href = '/myfocus#/mobileChange';
			            }else{
			                alert(res.errorMessage);
											That.changeImg();
			            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UCOrder = React.createClass({displayName: "UCOrder",
		getInitialState: function(){
			return {
				res: {
					data: {
		...
		componentDidMount: function(){
			$(window).scrollTop(0)
			var That = this;
			$('.uc-order-box').css('min-height', $(window).height() - $('header').height() + $('.public-breadcrumb-bottom').height() - $('footer').height() - 15 + 'px');
			$.ajax({
				url: '/wap/order',
				type: 'post',
				dataType: 'json',
		...
		render: function(){
			var hostName = Tools.getHostName();
			var yxhd_domain = hostName == 'focustest' ? 
				'http://saleswap.wxmall.focustest.cn/' : 'http://yxhd.focus.cn/' ;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UCFinance = React.createClass({displayName: "UCFinance",
		getInitialState: function(){
			return {
				res: {
					data: {
		...
		render: function(){
			...
			var h = ($(window).height() - $('header').height() + $('.public-breadcrumb-bottom').height() - $('footer').height() - 15) + 'px'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UCHeader = __webpack_require__(222),
		UCFooter = __webpack_require__(224),
		UCBreadCrumb = __webpack_require__(225),
		UCTop = __webpack_require__(238),
		UCList = __webpack_require__(239),
		Tools = __webpack_require__(223);

	var UCMain = React.createClass({displayName: "UCMain",
		getInitialState: function(){
			return {
				res: {
					data: {
					...
					if(That.isMounted()){
						if(res.errorCode === 0){
							...
							if(!res.data.user.nickName){
								res.data.user.nickName = res.data.user.userName;
							}
								newState.res = res;

							var checkReg = /^1[3|4|5|7|8]\d{9}@sohu.com$/;
							if(checkReg.test(res.data.user.nickName)){
								res.data.user.nickName = res.data.user.nickName.substr(0,3) + '****' + res.data.user.nickName.substr(7, 4);
							}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UCTop = React.createClass({displayName: "UCTop",
		render: function(){
			return (
				React.createElement("div", {className: "usercenter-top"}, 
					React.createElement(UCInfo, {data: this.props.data}), 
					React.createElement(UCCount, {data: this.props.data})
				)
			);
		}
	});

	var UCInfo = React.createClass({displayName: "UCInfo",

		render: function(){
			return (
				React.createElement(Link, {to: "/info"}, 
				React.createElement("div", {className: "usercenter-bg"}, 
					React.createElement("div", {className: "avatar-box"}, 
						React.createElement("img", {className: "user-avatar", src: this.props.data.data.user.avatar})
					), 
					React.createElement("p", {className: "user-name"}, this.props.data.data.user.nickName), 
	...
	var UCCount = React.createClass({displayName: "UCCount",
		render: function(){
			return (
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UCList = React.createClass({displayName: "UCList",
		getCookieFn: function(cookieName){
		...
		render: function(){
			var isLogin = this.getCookieFn('ppinf') != '';
			var hostName = Tools.getHostName();

			return (
				React.createElement("div", {className: "usercenter-list"}, 
					React.createElement("div", {className: "usercenter-list-p1"}, 
					...
					React.createElement("div", {className: "usercenter-list-p3"}, 
						React.createElement("div", {className: "item-box"}, 
					...
					React.createElement("div", {className: "usercenter-list-p2"}, 
						React.createElement("div", {className: "item-box"}, 
					...
					React.createElement("div", {className: "usercenter-list-p4", style: {display: 'none'}}, 
						React.createElement("div", {className: "item-box"}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginValidator = function(nextState, replaceState){

		var isLogin = Tools.getCookieFn('ppinf');
		if(isLogin == ''){
		    replaceState({ nextPathname: nextState.location.pathname }, '/');
			document.location.href = 'http://login.'+ Tools.getHostName() +'.cn/login?ru='+ encodeURIComponent('http://' + document.location.host + '/myfocus#' + nextState.location.pathname);
		}
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InfoValidator = function(nextState, replaceState){

		var isLogin = Tools.getCookieFn('ppinf');
		if(isLogin == ''){
		    replaceState({ nextPathname: nextState.location.pathname }, '/');
			document.location.href = 'http://login.'+ Tools.getHostName() +'.cn/login?ru='+ encodeURIComponent('http://' + document.location.host + '/myfocus');
		}
	}
